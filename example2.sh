...
time ./rnnlm -train train -valid valid -rnnlm model -hidden 15 -rand-seed 1 -debug 2 -class 100 -bptt 0 -bptt-block 10 -direct-order 0 -factor 7 -domain 1 -direct 0 -binary 
