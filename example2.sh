...
time ./rnnlm -train train -valid valid -rnnlm model -hidden 15 -rand-seed 1 -debug 2 -class 100 -bptt 0 -bptt-block 10 -direct-order 0 -factor 15 -domain 1 -train_domain_file train_domain_file   -direct 0 -binary 
